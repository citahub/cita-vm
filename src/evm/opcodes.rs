...
impl fmt::Display for OpCode {
    fn fmt(&self, f: &mut fmt::Formatter) -> fmt::Result {
        match *self {
            ...
            OpCode::BLOBBASEFEE => write!(f, "BLOBBASEFEE"),
...
impl OpCode {
    ...
    pub fn gas_price_tier(&self) -> GasPriceTier {
        match self {
            ...
            OpCode::BLOBBASEFEE => GasPriceTier::Base,
            ...
            OpCode::TLOAD => GasPriceTier::Zero,
            OpCode::TSTORE => GasPriceTier::Zero,
            OpCode::MCOPY => GasPriceTier::VeryLow,
