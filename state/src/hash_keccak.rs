...
// hash_keccak is a full implementation of Parity's state.
//
// Because we need to do a complete test, use keccak hash in develop and test,
// and switch to sha3 at product.
